<?php
/*
	Plugin Name: Hatena Bookmark Autopost
...
// 投稿メニューへのフィールド追加
add_action( 'admin_init', 'easy_cpts_hatena_bookmark_autopost' );

function easy_cpts_hatena_bookmark_autopost() {
     add_settings_field(
          'htn_bm_email', // id
...
add_action( 'publish_post', 'hatena_bookmark_autopost', 1 ,6);

function hatena_bookmark_autopost($post_id) {
